          ...
          <div className="grid w-full grid-cols-1 gap-15 lg:grid-cols-2 lg:gap-0">
            <div className="flex flex-col gap-4">
              ...
              <span className="text-muted-foreground text-sm leading-5">
                Albor Digital Canada — Canadian-owned web studio. Canmore,
                Alberta.
              </span>
              <div>
            ...
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 md:gap-0">
            ...
            <div>
              <span className="flex items-center gap-1">
                ...
                <span className="text-muted-foreground text-xs leading-5 font-medium">
                  © 2026 Albor Digital Canada. All rights reserved.
                </span>
              </span>
            </div>
